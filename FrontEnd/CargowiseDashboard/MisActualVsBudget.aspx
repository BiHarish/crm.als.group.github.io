<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="MisActualVsBudget.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.CargowiseDashboard.MisActualVsBudget" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>
            <asp:Label ID="lblHeading" runat="server" Text="MIS Actual Year Wise"></asp:Label></h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <asp:Chart ID="ChartMisActual" runat="server" EnableViewState="true" X-axis="continous"
                        ...
                        <Series>
                            <asp:Series Name="Series2" XValueMember="MName" PostBackValue="#VALX" YValueMembers="MValue"
                                LegendText="Mis Actual" ToolTip="#VALY" IsValueShownAsLabel="true" ChartArea="ChartMisActual"
                                MarkerBorderColor="#DBDBDB">
                            </asp:Series>
                            <asp:Series Name="Series3" XValueMember="MName" PostBackValue="#VALX" YValueMembers="BValue"
                                LegendText="Mis Budget" ToolTip="#VALY" IsValueShownAsLabel="true" ChartArea="ChartMisActual"
                                MarkerBorderColor="#DBDBDB">
                            </asp:Series>
                        </Series>
                        <Legends>
                        ...
                        <ChartAreas>
                            <asp:ChartArea Name="ChartMisActual">
