<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="UnAdjustedReceipt.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.CargowiseDashboard.UnAdjustedReceipt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>
            <asp:Label ID="lblHeading" runat="server" Text="Receipt(Unadjusted) Dashboard"></asp:Label></h1>
    </section>
