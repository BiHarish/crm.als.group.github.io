<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="AgeingClarion.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.Reports.AgeingClarion" %>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" ID="drpCompanyMaster" AutoPostBack="true" CssClass="form-control select2" OnSelectedIndexChanged="drpCompanyMaster_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Party Code</label>
                            <asp:DropDownList runat="server" ID="drpDebtor" CssClass="form-control select2">
                ...
                <div class="box-footer text-center">
                    ...
                    <%--<asp:Button runat="server" data-loading-text="Loading...Please Wait" CssClass="btn btn-primary btn-flat" OnClick="btnExport_Click" Text="Excel" ID="btnExport" />--%>
                      <asp:Button ID="btnExport" CssClass="btn btn-primary" Text="Excel" runat="server" OnClick="btnExport_Click"  />
                </div>
                <!-- /.row -->
                <!-- /.box-body -->
                <div class="divscroll">
                    <asp:GridView ID="gvUserList" Width="100%" CssClass="grid" runat="server" ShowFooter="false" AutoGenerateColumns="true" AllowPaging="true" PageSize="1000" OnRowEditing="gvUserList_RowEditing"
                        AlternatingRowStyle-BackColor="White" OnRowCommand="gvUserList_RowCommand" OnRowDeleting="gvUserList_RowDeleting" OnPageIndexChanging="gvUserList_PageIndexChanging" Style="width: 100%; overflow: scroll">
                        <%--    <Columns>
