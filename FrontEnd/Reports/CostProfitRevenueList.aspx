<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="CostProfitRevenueList.aspx.cs" Inherits="ICWR.FrontEnd.Reports.CostProfitRevenueList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Monthly CostRevenue Report</h1>
    </section>
    <section class="content">
        ...
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <!-- /.box-body -->
                <div class="divscroll">
                    <asp:GridView ID="gvUserList" Width="100%" CssClass="grid" runat="server" ShowFooter="false" AutoGenerateColumns="true" AllowPaging="true" PageSize="250" OnRowEditing="gvUserList_RowEditing"
