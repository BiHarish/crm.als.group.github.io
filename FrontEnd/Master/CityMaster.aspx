<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="CityMaster.aspx.cs" Inherits="ICWR.FrontEnd.Master.CityMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" ID="ddlState" CssClass="form-control select2"></asp:DropDownList>
                        </div>
                        <!-- /.form-group -->
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" ID="txtName" CssClass="form-control" placeholder="City Name"></asp:TextBox>
                        </div>
                        <!-- /.form-group -->
                    </div>
                    <!-- /.col -->
        ...
        <div class="box box-success collapsed-box box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Active City List</h3>
                <div class="box-tools pull-right">
                    ...
                    <div class="col-md-12">
                        <asp:GridView ID="grdActiveProduct" Width="100%" CssClass="grid" runat="server" ShowFooter="false" AutoGenerateColumns="false" OnRowDeleting="grdActiveProduct_RowDeleting" AllowPaging="true" PageSize="25"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="City Id" Visible="false" HeaderStyle-Width="12%">
                                    <ItemTemplate>
                                        <asp:Label ID="CityId" runat="server" Text='<%# Eval("CityId") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="City Name" Visible="true" HeaderStyle-Width="15%">
                                    <ItemTemplate>
                                        <asp:Label ID="CityName" runat="server" Text='<%# Eval("CityName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Deactive City" HeaderStyle-Width="15%">
                                    <ItemTemplate>
                                        <asp:ImageButton runat="server" Width="25" ID="btnDeactive" CommandName="Delete" ImageUrl="/FrontEnd/Scripts/Image/Delete.png" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Edit City" HeaderStyle-Width="15%">
                                    <ItemTemplate>
        ...
        <div class="box box-success collapsed-box box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Deactive City List</h3>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
                    <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
                </div>
