<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="FreightForwardingCrm.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.Operations.FreightForwardingCrm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>
            <asp:Label ID="lblMainHeading" runat="server" Text="Freight Forwarding"></asp:Label></h1>
    </section>
    <%--Main content--%>
    <section class="content">
        <div class="box box-success box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <asp:Label ID="lblSecHeading" runat="server" Text="FF"></asp:Label></h3>
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" ID="drpCustomerName" CssClass="form-control select2" placeholder="Customer Name" AutoComplete="off"
                                AutoPostBack="true" OnSelectedIndexChanged="drpCustomerName_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:Label ID="txtTradelane" runat="server"></asp:Label>
                            <asp:DropDownList ID="drpTradeLane" runat="server" CssClass="form-control select2">
                                <%-- <asp:ListItem Value="">--Select--</asp:ListItem>
                                <asp:ListItem Value="Africa">Africa</asp:ListItem>
                                <asp:ListItem Value="America/Latin America">America/Latin America</asp:ListItem>
                                <asp:ListItem Value="China">China</asp:ListItem>
                                <asp:ListItem Value="EU">EU</asp:ListItem>
                                <asp:ListItem Value="Far East">Far East</asp:ListItem>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>
                                <asp:Label ID="lblLocationFrom" runat="server" Visible="false" Text="LocationFrom:"></asp:Label>
                                <asp:Label ID="lblLocationStar" Visible="false" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label>

                            </label>
                            <%--<asp:Label ID="txtLocFrom" runat="server" ></asp:Label>--%>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <%--<asp:Label ID="txtLocTo" runat="server" ></asp:Label>--%>
                    ...
                    <div class="col-md-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtQty" runat="server" Visible="false" CssClass="form-control groupOfTexbox" AutoPostBack="true" OnTextChanged="txtQty_TextChanged"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>
                                    <asp:Label ID="lblUnit" runat="server" Text="Unit(UOM):" Visible="false"></asp:Label><asp:Label ID="lblUnitStar" Visible="false" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label>
                                </label>
                                <asp:DropDownList ID="drpUnit" runat="server" CssClass="form-control select2" Visible="false">
                                    ...
                                    <asp:ListItem Value="SpecialEquipment">SpecialEquipment</asp:ListItem>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:Label ID="txtCrmStage" runat="server"></asp:Label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" ID="txtMothlyBilling" CssClass="form-control groupOfTexbox" placeholder="Monthly Billing" AutoComplete="off" oncopy="return false" onpaste="return false" AutoPostBack="true" OnTextChanged="txtMothlyBilling_TextChanged"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>
                                <asp:Label ID="lblRate" runat="server" Text="Rate:" Visible="false"></asp:Label><asp:Label ID="lblRateStar" Visible="false" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label>
                            <asp:TextBox runat="server" ID="txtRate" CssClass="form-control groupOfTexbox" AutoComplete="off"
                                AutoPostBack="true" OnTextChanged="txtRate_TextChanged" Visible="false" oncopy="return false" onpaste="return false">
                            </asp:TextBox>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Shipment_Count:<asp:Label ID="lblShipmentstar" runat="server" ForeColor="Red" Text="*" Font-Bold="true"></asp:Label></label>
                            <asp:TextBox ID="txtShipment" runat="server" CssClass="form-control groupOfTexbox" oncopy="return false" onpaste="return false"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>CFS/ICD:</label>
                            <asp:DropDownList ID="DrpCfs" runat="server" CssClass="form-control select2">
                                <asp:ListItem Value="">--Select--</asp:ListItem>
                                <asp:ListItem Value="Panvel">Panvel</asp:ListItem>
                                <asp:ListItem Value="Tuticorin">Tuticorin</asp:ListItem>
                                <asp:ListItem Value="Kattupalli">Kattupalli</asp:ListItem>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>IncoTerms:<asp:Label ID="lblstarincoterm" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label><br />
                            <asp:DropDownList ID="drpIncoterms" runat="server" Style="width: 206px !important" CssClass="form-Control select2">
                                <asp:ListItem Value="">--Select--</asp:ListItem>
                                ...
                                <asp:ListItem Value="DAT">DAT</asp:ListItem>
                                ...
                                <asp:ListItem Value="GFR">GFR</asp:ListItem>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Branch/Office:<asp:Label ID="Label4" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label><br />
                            <asp:DropDownList ID="drpBranch" runat="server" CssClass="form-Control select2" Style="width: 206px !important">
                            </asp:DropDownList>
                        </div>
                    </div>
