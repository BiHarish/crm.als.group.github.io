<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="CustomBrokerageList.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.Operations.CustomBrokerageList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>
            ...
            <asp:Label ID="lblSecHeading" runat="server" Text="Custom Brokerage List"></asp:Label></h1>
    </section>
    <!-- Main content -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <%--line of Business--%>
                            <label>
                                <asp:Label ID="lblLineOfBusiness" runat="server" Text="Line Of Business"></asp:Label></label><br />
