<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="FreightForwardingList.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.Operations.FreightForwardingList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>
            ...
            <asp:Label ID="lblSecHeading" runat="server" Text="FF List"></asp:Label></h1>
    </section>
    <!-- Main content -->
                    ...
                    <div class="col-md-12">
                        <div class="form-group" style="padding-left: 16px;">
                            ...
                            <asp:LinkButton runat="server" class="btn btn-primary btn-flat" data-loading-text="Loading...Please Wait" Visible="false"
                                ID="lnkUserDownload" Style="margin-top: 25px" OnClick="ExcelDownloadFileForFFUser">
                                    <span class="glyphicon glyphicon-download-alt"></span> Excel Download
                            </asp:LinkButton>
                            ...
                            <asp:GridView ID="gvLeadList" Width="100%" CssClass="grid" runat="server" ShowFooter="false" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Billing" HeaderStyle-Width="10%" >
                                        <ItemTemplate>
                                            <asp:Label ID="gvlblBilling" runat="server" Text='<%# Eval("MonthlyBilling","{0:0.00}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
