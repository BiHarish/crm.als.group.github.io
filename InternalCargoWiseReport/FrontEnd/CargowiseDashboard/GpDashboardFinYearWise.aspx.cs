...
{
    public partial class GpDashboardFinYearWise : System.Web.UI.Page
    {
        ...
        void getData()
        {
            OutResult result = InternalQuery.Query.get2ndDashboard(drpFinYear.SelectedValue, drpCompanyCode.SelectedValue);
            if (result.ex == null)
            {
                if (result.ds != null)
                {
