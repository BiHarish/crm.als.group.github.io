...
{
    public partial class RevenueDashboard : System.Web.UI.Page
    {
        string MonthWise;
        string YearWise;
        ...
        void getRevenue()
        {
           ...
           // OutResult result1 = InternalQuery.Query.Dashboard_AllInOneGP(Date,  "AFL");
            OutResult result = InternalQuery.Query.Dashboard_BillCost(Date, "AR", "INV");
            if (result.ex == null)
            {
                if (result.ds != null)
                {
