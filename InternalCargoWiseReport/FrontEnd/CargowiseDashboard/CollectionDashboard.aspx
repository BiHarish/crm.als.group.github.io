<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="CollectionDashboard.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.CargowiseDashboard.CollectionDashboard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        var chart = AmCharts.makeChart("divYearWise", {
            ...
            "dataProvider": [<asp:Literal ID="ltrYearWise" runat="server"></asp:Literal>],
            "valueField": "Value",
            "titleField": "Name",
            "outlineAlpha": 0.4,
           // "depth3D": 15,
           ...
           "depth3D": 0,
           // "balloonText": "[[title]]<br><span style='font-size:14px'><b>[[value]]</b> ([[percents]]%)</span><br>[[title]]<br><span style='font-size:14px'><b>[[value]]</b> ([[percents]]%)</span>",
           
 "balloonText": "<style>table { background-color: coral, font-family: arial, sans-serif;  border-collapse: collapse;  width: 100%;} td, th {  border: 1px solid #dddddd;  text-align: left;  padding: 8px;} tr:nth-child(even) {  background-color: #dddddd;} </style><h2>HTML Table</h2><table><tr><th>Company</th><th>Contact</th><th>Country</th></tr><tr><td>Alfreds Futterkiste</td><td>Maria Anders</td><td>Germany</td></tr><tr><td>Centro comercial Moctezuma</td><td>Francisco Chang</td><td>Mexico</td></tr><tr><td>Ernst Handel</td><td>Roland Mendel</td><td>Austria</td></tr></table>",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>
            <asp:Label ID="lblHeading" runat="server" Text="Collection Dashboard"></asp:Label></h1>
    </section>
