<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="VerifyMemberList.aspx.cs" Inherits="ICWR.FrontEnd.MemberMaster.VerifyMemberList" %>
        ...
        <div class="box box-success box-solid">
            ...
            <asp:GridView ID="gvUserList" Width="100%" CssClass="grid" runat="server" ShowFooter="false" AutoGenerateColumns="false" AllowPaging="true" PageSize="25" OnRowEditing="gvUserList_RowEditing"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Card" Visible="true" HeaderStyle-Width="10%">
                        <ItemTemplate>
                            <asp:Label ID="Card" runat="server" Text='<%# Eval("BankImage") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Amount" Visible="true" HeaderStyle-Width="10%">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="User Unverify" HeaderStyle-Width="7%">
                        <ItemTemplate>
                            <asp:ImageButton runat="server" Width="25" ID="btnDelete" CommandName="UnVerify" ImageUrl="/FrontEnd/Scripts/Image/Delete.png" />
                        </ItemTemplate>
                    </asp:TemplateField>
