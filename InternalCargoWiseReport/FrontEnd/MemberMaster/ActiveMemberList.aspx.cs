...
{
    public partial class ActiveMemberList : CustomBasePage
    {
        #region Properties
        ...
        protected void gvUserList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Delete")
            {
                try
                {
                    ...
                    {
                        gvUserList.Visible = false;
                        Toastr.ShowToast(this.Page, Toastr.ToastType.Success, "User Delete Successfully", "Success!", Toastr.ToastPosition.TopCenter, true);
                    }
                    else
                    {
