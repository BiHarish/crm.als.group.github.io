<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="UnverifyMemberList.aspx.cs" Inherits="ICWR.FrontEnd.MemberMaster.UnverifyMemberList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            loadingbuttononPage(<%= btnVerify.ClientID %>);
        });
    </script>
</asp:Content>
        ...
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <div class="box-footer text-center">
                    ...
                    <asp:Button runat="server" data-loading-text="Loading...Please Wait" CssClass="btn btn-success btn-flat" OnClick="btnVerify_Click" Text="Verify" ID="btnVerify" />
                </div>
                <!-- /.row -->
            </div>
            <!-- /.box-body -->
            <asp:GridView ID="gvUserList" Width="100%" CssClass="grid" runat="server" ShowFooter="false" AutoGenerateColumns="false" AllowPaging="true" OnRowDataBound="gvUserList_RowDataBound"
                AlternatingRowStyle-BackColor="White" OnRowCommand="gvUserList_RowCommand" OnPageIndexChanging="gvUserList_PageIndexChanging" PageSize="25">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="User Verify" HeaderStyle-Width="7%">
                        <ItemTemplate>
