...
{
    public partial class DiffOrderEstimateVsActualList : CustomBasePage
    {
        #region Properties
        ...
        {
            EstimatevsActualData _estimateActualData = new EstimatevsActualData();

            DataTable dt = _estimateActualData.GetOrderDiff(DateFrom, DateTo, drpCompanyMaster.SelectedValue);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                ...
                string filePath = "EstimateVSActual.xlsx";
