...
{
    public partial class EstimateVsActualList : CustomBasePage
    {
        #region Properties
        ...
        private void BindInformation()
        {
            ...
            DataTable dt = _estimateActualData.GetEstimateActual(DateFrom,DateTo,drpCompanyMaster.SelectedValue);
