...
{
    public partial class AgeingClarion : System.Web.UI.Page
    {
       #region Properties
        ...
        private void BindInformation()
        {
            ...
            DataTable dt = _userActivityData.GetAgeingPartyWise(DateFrom, drpCompanyMaster.SelectedValue,drpDebtor.SelectedValue);
        ...
        protected void drpCompanyMaster_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                ...
                drpDebtor.DataBind();
                drpDebtor.Items.Insert(0, new ListItem("--Select--", string.Empty));
            }
        }
    }
}