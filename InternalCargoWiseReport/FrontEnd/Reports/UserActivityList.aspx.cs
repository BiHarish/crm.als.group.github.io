...
{
    public partial class UserActivityList : CustomBasePage
    {
        #region Properties
        ...
        {
            UserActivityData _userActivityData = new UserActivityData();

            DataTable dt = _userActivityData.GetUserActivityByDateFromTo(DateFrom, DateTo);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                string filePath = "UserActivity.xlsx";
