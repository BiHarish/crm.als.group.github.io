...
{
    public partial class RDispatchList : CustomBasePage
    {
        #region Properties
        ...
        private void BindInformation()
        {
            ...
            DataTable dt = _dispatchData.GetDispatchDataByDateFromTo(DateFrom, DateTo, drpCompanyMaster.SelectedValue);
