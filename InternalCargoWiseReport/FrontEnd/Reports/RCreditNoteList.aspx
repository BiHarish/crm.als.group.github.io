<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="RCreditNoteList.aspx.cs" Inherits="ICWR.FrontEnd.Reports.RCreditNoteList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>CreditNote-Invoice Report</h1>
    </section>
    <section class="content">
        ...
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <asp:GridView ID="gvUserList" Width="100%" CssClass="grid" runat="server" ShowFooter="false" AutoGenerateColumns="true" AllowPaging="true" PageSize="25" OnRowEditing="gvUserList_RowEditing"
