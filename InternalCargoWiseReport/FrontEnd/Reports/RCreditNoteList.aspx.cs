...
{
    public partial class RCreditNoteList : CustomBasePage
    {
        #region Properties
        ...
        {
            DispatchData _dispatchData = new DispatchData();

            DataTable dt = _dispatchData.GetCreditNoteDataByDateFromTo(DateFrom, DateTo, drpCompanyMaster.SelectedValue);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                string filePath = "CreditNoteInv.xlsx";
