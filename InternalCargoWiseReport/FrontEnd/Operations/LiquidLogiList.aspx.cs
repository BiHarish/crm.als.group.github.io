...
{
    public partial class LiquidLogiList : System.Web.UI.Page
    {
        int count;
        int count1 = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (LovelySession.Lovely.User.UserTypeId != 9 && LovelySession.Lovely.User.UserTypeId != 1 && LovelySession.Lovely.User.UserTypeId != 11
                    && LovelySession.Lovely.User.UserTypeId != 13 && LovelySession.Lovely.User.UserTypeId != 22  && LovelySession.Lovely.User.UserTypeId != 25)
                {
        ...
        void bindGrid()
        {
            ...
            IList<WHLeadMasterDto> results = _whleadMasterData.GetByCustomerName(drpCustomerName.SelectedValue, CreateBy, drpStage.SelectedValue, 
                ...
                LovelySession.Lovely.User.UserTypeId, "Liquid", LovelySession.Lovely.User.Id, drpDesignatedBD.SelectedValue, txtCreateFromDate.Text, txtCreateToDate.Text,
        ...
        {
            WHLeadMasterData _whleadMasterData = new WHLeadMasterData();
            //IList<WHLeadMasterDto> CustomerList = _whleadMasterData.getAllCustomerList(LovelySession.Lovely.User.UserTypeId, "Liquid", LovelySession.Lovely.User.Id);
            ...
            IList<WHLeadMasterDto> getSegment = _leadData.getSegment(LovelySession.Lovely.User.UserTypeId, "Liquid");
            if (getSegment != null)
            {
            ...
            IList<WhCustomerMasterDto> customerResults = _customerMasterData.GetAll("Liquid");
        ...
        protected void gvLeadList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                try
                {
                    ...
                    {
                        Response.Redirect("LiquidLogi.aspx?lovelyindexing=112&requestId=" + requestId + "&726782dsjsbj=3877843hdws", false);
                    }
                    else
                    {
        ...
        {
            Response.Redirect("~/FrontEnd/Operations/LiquidLogi.aspx");
        }
        ...
        protected void ExcelDownloadFile(object sender, EventArgs e)
        {
            ...
            DataSet result = _whLeadData.getForWhLeadMasterExelForLiquid(drpCustomerName.SelectedValue, drpNewEncirclement.SelectedValue,
                drpStatusStage.SelectedValue, drpStage.SelectedValue, LovelySession.Lovely.User.UserTypeId, drpRegion.SelectedValue, drpSegment.SelectedValue,
                drpLineOfBusiness.SelectedValue, drpDesignatedBD.SelectedValue, txtCreateFromDate.Text, txtCreateToDate.Text,
                txtModifyFromDate.Text, txtModifyToDate.Text, drpCurrentStatus.SelectedValue);
            if (result != null)
            {
