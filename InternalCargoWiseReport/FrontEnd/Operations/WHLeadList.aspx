<%@ Page Title="ALS-CRM" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="WHLeadList.aspx.cs" EnableEventValidation="true" Inherits="InternalCargoWiseReport.FrontEnd.Operations.WHLeadList" %>
                    ...
                    <div class="col-md-12">
                        <div class="form-group" style="padding-left: 16px;">
                           ...
                           <a href = "~/FrontEnd/Operations/ExcelDownloadForUpload/FileUploadFormat.xlsx" id="href"  class="btn btn-primary btn-flat"
                             ...
                             <asp:LinkButton runat="server" class="btn btn-primary btn-flat" data-loading-text="Loading...Please Wait"
                                ID="lnkCustomerHistory" Style="margin-top: 25px" OnClick="lnkCustomerHistory_Click">
                                      Customer History 
                            </asp:LinkButton>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <asp:GridView ID="gvLeadList" Width="100%" CssClass="grid" runat="server" ShowFooter="false" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Special Input" Visible="false" HeaderStyle-Width="15%">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                     ...
                                     <asp:TemplateField HeaderText="D&B" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblFileName" runat="server" Text='<%# Eval("FileName") %>' Visible="false"></asp:Label>
                                            <asp:ImageButton runat="server" Width="25" ID="imgBtnDownload" OnClick="imgBtnDownload_Click"
                                                 ImageUrl="~/FrontEnd/Scripts/Image/DownloadList.png" ToolTip="Download"
 ...
 left: 209px; top: 231px; border: solid;">
                ...
                <div class="body">
                    <table style="width: 100%">
                        <asp:GridView ID="gvStatus" runat="server" AutoGenerateColumns="false" Width="80%">
                            <Columns>
