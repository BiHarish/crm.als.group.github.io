...
{
    public partial class PrimeList : System.Web.UI.Page
    {
        int count;
        int count1 = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (LovelySession.Lovely.User.UserTypeId != 9 && LovelySession.Lovely.User.UserTypeId != 1 && LovelySession.Lovely.User.UserTypeId != 11
                    && LovelySession.Lovely.User.UserTypeId != 15 && LovelySession.Lovely.User.UserTypeId != 22 && LovelySession.Lovely.User.UserTypeId != 25)
                {
        ...
        void bindGrid()
        {
            ...
            IList<WHLeadMasterDto> results = _whleadMasterData.GetByCustomerName(drpCustomerName.SelectedValue, CreateBy, string.Empty, drpStatusStage.SelectedValue,
                drpNewEncirclement.SelectedValue, drpRegion.SelectedValue, drpSegment.SelectedValue, drpLineOfBusiness.SelectedValue,
                LovelySession.Lovely.User.UserTypeId, "Prime", LovelySession.Lovely.User.Id, drpDesignatedBD.SelectedValue, txtCreateFromDate.Text, txtCreateToDate.Text,
        ...
        void StatusUpload()
        {
            ...
            if (fileUpload.HasFile)
            {
                try
                {
                    ...
                    request.UserTypeID = "15,16"; //LovelySession.Lovely.User.UserTypeId;
        ...
        protected void gvLeadList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                try
                {
                    ...
                    {
                        Response.Redirect("Prime.aspx?lovelyindexing=119&requestId=" + requestId + "&726782dsjsbj=3877843hdws", false);
                    }
                    else
                    {
        ...
        protected void gvLeadList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (LovelySession.Lovely.User.UserTypeId == 1 || LovelySession.Lovely.User.UserTypeId == 15 || LovelySession.Lovely.User.UserTypeId == 25)
                {
                    img.Visible = true;
                    return;
                }
        ...
        {
            Response.Redirect("~/FrontEnd/Operations/Prime.aspx");
        }
        ...
        protected void ExcelDownloadFile(object sender, EventArgs e)
        {
            ...
            DataSet result = _whLeadData.getForWhLeadMasterExelForPrime(drpCustomerName.SelectedValue, drpNewEncirclement.SelectedValue,
                ...
                drpLineOfBusiness.SelectedValue, "Prime", drpDesignatedBD.SelectedValue, txtCreateFromDate.Text, txtCreateToDate.Text,
                txtModifyFromDate.Text, txtModifyToDate.Text, drpCurrentStatus.SelectedValue);
            if (result != null)
            {
