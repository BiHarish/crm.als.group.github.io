...
{
    public partial class CustomBrokerageWeb : System.Web.UI.Page
    {
        long? WHLeadID;
        string strFileName;
        ...
        bool validation()
        {
            ...
            {
                if (drpLineOfBusiness.SelectedValue == "Ocean Export" || drpLineOfBusiness.SelectedValue == "Ocean Import" || drpLineOfBusiness.SelectedValue == "Air Import"
                    || drpLineOfBusiness.SelectedValue == "Air Export" )
                {
        ...
        void setData()
        {
            ...
            if (result != null)
            {
                ...
                if (result.Revenue.ToDataConvertDouble() != 0)
                {
                    ...
                    txtRealizationExpected.Enabled = false;
                }
            }
            else
            {
        ...
        void bindDrp()
        {
            ...
            IList<WhBuMasterDto> results = _serviceTypeMasterData.GetOnlyCustomBrokerage();
            if (results != null)
            {
        ...
        public bool SaveLeadTypeTransaction()
        {
            try
            {
                foreach (GridViewRow gvRow in gvLeadTypeTransaction.Rows)
                {
                    ...
                    obj.LeadType = gvlblleadType.Text;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (HfID.Value == string.Empty || HfID.Value == "0")
            {
                ...
                {
                    saveStatusGridData();
                    if (drpLineOfBusiness.SelectedValue == "Warehousing" || drpLineOfBusiness.SelectedValue == "Transportation")
                    {
        ...
        {
            Response.Redirect("~/FrontEnd/Operations/CustomBrokerageList.aspx");
        }
        #endregion
        ...
        protected void gvLeadTypeTransaction_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                else if (gvlblID.Text == "Transportation")
                {
                    ...
                    drp.Items.Insert(3, new ListItem("Carton", "Carton"));
                    drp.Items.Insert(4, new ListItem("Trip", "Trip"));
                    drp.Items.Insert(5, new ListItem("Vehicle", "Vehicle"));
                }
                else if (gvlblID.Text == "InPlant")
                {
                    drp.Items.Insert(0, new ListItem("--Select--", string.Empty));
                    drp.Items.Insert(1, new ListItem("Unit", "Unit"));
                    drp.Items.Insert(2, new ListItem("Sqft", "Sqft"));
        ...
        protected void gvtxtQty_Nos_TextChanged(object sender, EventArgs e)
        {
            ...
            txtRevenue.Text = totMonthlyBilling.ToString();
            RevenueRange();
        }
        ...
        protected void drpLineOfBusiness_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (drpLineOfBusiness.SelectedValue != string.Empty)
            {
                     ...
                     || drpLineOfBusiness.SelectedValue == "Air Export" )
                {
                    ...
                    drpValueAddedList.Visible = false;
                    divScroll.Visible = false;
                    gvLeadTypeTransaction.Visible = false;

                  
                }
                else if(drpLineOfBusiness.SelectedValue=="Transportation" || drpLineOfBusiness.SelectedValue=="Warehousing")
                {
        ...
        protected void txtRealizationExpected_TextChanged(object sender, EventArgs e)
        {
            if (txtRealizationExpected.Text.Trim() == string.Empty && txtTues.Text.Trim() != string.Empty)
            {
                Toastr.ShowToast(this.Page, Toastr.ToastType.Error, "Please Enter Realization Expected", "Oops!", Toastr.ToastPosition.TopCenter, true);
                txtRevenue.Text = "0";
                RevenueRange();
            ...
            if (txtTues.Text.Trim() != string.Empty && txtRealizationExpected.Text.Trim() != string.Empty)
            {
                txtRevenue.Text = (txtTues.Text.ToDouble() * txtRealizationExpected.Text.ToDouble()).ToString();
                RevenueRange();
            }
