...
namespace InternalCargoWiseReport.FrontEnd.Operations
{
    ...
    public partial class WHLeadList : System.Web.UI.Page
    {
        int count;
        int count1 = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if(Session["Name"]!=null || Session["TypeOfBusiness"]!=null || Session["Stage"]!=null || Session["StatusStage"]!=null
                    || Session["Region"]!=null || Session["Segment"]!=null || Session["LineOfBusiness"]!=null)
                {
                   //  drpCustomerName.SelectedValue = Session["Name"].ToString();
                   //  drpNewEncirclement.SelectedValue = Session["TypeOfBusiness"].ToString();
                   //  drpStage.SelectedValue = Session["Stage"].ToString();
                ...
                sessionEnd();
                    ...
                    if (LovelySession.Lovely.User.UserTypeId != 9 && LovelySession.Lovely.User.UserTypeId != 1 && LovelySession.Lovely.User.UserTypeId != 11
                        && LovelySession.Lovely.User.UserTypeId != 22 && LovelySession.Lovely.User.UserTypeId != 25)
                    {
        ...
        void bindGrid()
        {
            ...
            IList<WHLeadMasterDto> results = _whleadMasterData.GetByCustomerName(drpCustomerName.SelectedValue, CreateBy, drpStage.SelectedValue, 
                ...
                LovelySession.Lovely.User.UserTypeId,"SCS",LovelySession.Lovely.User.Id,drpDesignatedBD.SelectedValue,txtCreateFromDate.Text,txtCreateToDate.Text,
        ...
        {
            WHLeadMasterData _whleadMasterData = new WHLeadMasterData();
            //IList<WHLeadMasterDto> CustomerList = _whleadMasterData.getAllCustomerList(LovelySession.Lovely.User.UserTypeId,"SCS",LovelySession.Lovely.User.Id);
            //if (CustomerList != null)
            //{
            //    drpCustomerName.DataSource = CustomerList;
            ...
            IList<WHLeadMasterDto> CurrentStatusResults = _whleadMasterData.getAllLeadStatus();
            if(CurrentStatusResults!=null)
            {
                drpCurrentStatus.DataSource = CurrentStatusResults;
                drpCurrentStatus.DataValueField = "LeadCurrentStatus";
                drpCurrentStatus.DataTextField = "LeadCurrentStatus";
                drpCurrentStatus.DataBind();
                drpCurrentStatus.Items.Insert(0, new ListItem("--Select--", string.Empty));
            }
            else
            {
                drpCurrentStatus.Items.Clear();
                drpCurrentStatus.Items.Insert(0, new ListItem("--Select--", string.Empty));
            }
        ...
        protected void gvLeadList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                try
                {
                    ...
                    Session["Stage"] = drpStage.SelectedValue;
                    ...
                    {
                        //Response.Redirect("WHLead.aspx?lovelyindexing=112&requestId=" + requestId + "&726782dsjsbj=3877843hdws", false);
                       Response.Redirect("SCSCrmNew.aspx?lovelyindexing=112&requestId=" + requestId + "&726782dsjsbj=3877843hdws", false);
                    }
                    else
                    {
        ...
        protected void gvLeadList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label gvlblFileName = (e.Row.FindControl("lblFileName") as Label);
                ImageButton img = (e.Row.FindControl("btnEdit") as ImageButton);
                ImageButton DownloadFile = (e.Row.FindControl("imgBtnDownload") as ImageButton);
                if (gvlblFileName.Text == string.Empty)
                {
                    DownloadFile.Visible = false;
                }

                if (LovelySession.Lovely.User.UserTypeId == 9 || LovelySession.Lovely.User.UserTypeId == 1 || LovelySession.Lovely.User.UserTypeId == 11
                    || LovelySession.Lovely.User.UserTypeId == 22|| LovelySession.Lovely.User.UserTypeId == 25 || LovelySession.Lovely.User.UserTypeId == 23)
                {
                    img.Visible = true;
                    return;
                }
        ...
        {
           // Response.Redirect("~/FrontEnd/Operations/WHLead.aspx");
            Response.Redirect("~/FrontEnd/Operations/SCSCrmNew.aspx");
        }
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            if (dte != null)
            {
                ...
                try
                {
                    LovelyExport.ExportDataSetToExcel(dte, filePath);
        ...
        protected void ExcelDownloadFile(object sender, EventArgs e)
        {
            ...
            DataSet result = _whLeadData.getForWhLeadMasterExelForSCS(drpCustomerName.SelectedValue, drpNewEncirclement.SelectedValue,
                drpStatusStage.SelectedValue, drpStage.SelectedValue, LovelySession.Lovely.User.UserTypeId,drpRegion.SelectedValue,
                drpSegment.SelectedValue,drpLineOfBusiness.SelectedValue,drpDesignatedBD.SelectedValue
                ,txtCreateFromDate.Text,txtCreateToDate.Text,
                txtModifyFromDate.Text,txtModifyToDate.Text,drpCurrentStatus.SelectedValue);
           
            if (result != null)
            {
                string filePath = "SCSFile.xlsx";
                var appDataPath = Server.MapPath("~" + "\\SCSExcelFiles\\SCSFile.xlsx");
                try
                {
        ...
        protected void imgBtnDownload_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                var appDataPath = Server.MapPath("~/FrontEnd/Operations/CreditNoteFiles/" + filePath);
        ...
        protected void lnkCustomerHistory_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/FrontEnd/History/History.aspx");
        }
    }
}