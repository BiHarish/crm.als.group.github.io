...
{
    public partial class FreightForwardingList : System.Web.UI.Page
    {
            int count;
            int count1 = 0;
                ...
                if (!IsPostBack)
                {
                    ...
                    sessionEnd();
                            ...
                            && LovelySession.Lovely.User.UserTypeId != 22 && LovelySession.Lovely.User.UserTypeId != 25)
                        {
                            ...
                            href.Visible = false;
                            lnkUserDownload.Visible = true;

                        }
                        else
                        {
                            lnkUserDownload.Visible = false;
                        }
            ...
            void bindGrid()
            {
                ...
                IList<WHLeadMasterDto> results = _whleadMasterData.GetByCustomerName(drpCustomerName.SelectedValue, CreateBy, string.Empty,
                    drpStatusStage.SelectedValue, drpNewEncirclement.SelectedValue, drpRegion.SelectedValue, drpSegment.SelectedValue, 
                    drpLineOfBusiness.SelectedValue, LovelySession.Lovely.User.UserTypeId,"FF",LovelySession.Lovely.User.Id,
                    drpDesignatedBD.SelectedValue, txtCreateFromDate.Text, txtCreateToDate.Text,txtModifyFromDate.Text, txtModifyToDate.Text, drpCurrentStatus.SelectedValue);
            ...
            void StatusUpload()
            {
                ...
                if (fileUpload.HasFile)
                {
                    try
                    {
                        ...
                        request.UserTypeID = "11,12"; //LovelySession.Lovely.User.UserTypeId;
            ...
            protected void gvLeadList_RowCommand(object sender, GridViewCommandEventArgs e)
            {
                if (e.CommandName == "Edit")
                {
                    try
                    {
                        ...
                        {
                            Response.Redirect("FreightForwardingCrm.aspx?lovelyindexing=119&requestId=" + requestId + "&726782dsjsbj=3877843hdws", false);
                        }
                        else
                        {
            ...
            protected void gvLeadList_RowDataBound(object sender, GridViewRowEventArgs e)
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (LovelySession.Lovely.User.UserTypeId == 1 || LovelySession.Lovely.User.UserTypeId == 11 || LovelySession.Lovely.User.UserTypeId == 22 || LovelySession.Lovely.User.UserTypeId == 25)
                    {
                        img.Visible = true;
                        return;
                    }
                    ...
                    if(gvlblCreateBy.Text.ToLong()==LovelySession.Lovely.User.Id)
                    {
                        img.Visible = true;
                    }
                    //if (LovelySession.Lovely.User.UserTypeId == 17)
                    //{
                    //    gvLeadList.Columns[10].Visible = false;
                    //}
                }
            ...
            {
                Response.Redirect("~/FrontEnd/Operations/FreightForwardingCrm.aspx");
            }
            ...
            protected void ExcelDownloadFile(object sender, EventArgs e)
            {
                ...
                DataSet result = _whLeadData.getForWhLeadMasterExel(drpCustomerName.SelectedValue, drpNewEncirclement.SelectedValue,
                    drpStatusStage.SelectedValue, string.Empty, LovelySession.Lovely.User.UserTypeId, drpRegion.SelectedValue,
                    drpSegment.SelectedValue, drpLineOfBusiness.SelectedValue, "FF", drpDesignatedBD.SelectedValue, txtCreateFromDate.Text, txtCreateToDate.Text,
            ...
            protected void ExcelDownloadFileForFFUser(object sender, EventArgs e)
            {


                WHLeadMasterData _whLeadData = new WHLeadMasterData();

                DataSet result = _whLeadData.ExcelDownloadFileForFFUser(drpCustomerName.SelectedValue, drpNewEncirclement.SelectedValue, drpStatusStage.SelectedValue, 
                    LovelySession.Lovely.User.Id, drpRegion.SelectedValue, drpSegment.SelectedValue, drpLineOfBusiness.SelectedValue, txtCreateFromDate.Text, txtCreateToDate.Text,
                txtModifyFromDate.Text, txtModifyToDate.Text, drpCurrentStatus.SelectedValue);
                if (result != null)
                {
                    string filePath = "FFFiles.xlsx";
