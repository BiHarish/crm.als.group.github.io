...
{
    public partial class LiquidDashboard : System.Web.UI.Page
    {
        string MyData;
        string RegionData;
        ...
        private void bindPipelineChart()
        {
            ...
            IList<WHLeadMasterDto> results = _whLeadMasterData.getLiquidPipelineSplitRecord();
            if (results != null)
            {
        ...
        private void bindGeographyChart()
        {
            DataTable dt = new DataTable();
            WHLeadMasterData _whLeadMasterData = new WHLeadMasterData();
            IList<WHLeadMasterDto> results = _whLeadMasterData.getLiquidRegionRecord();
            if (results != null)
            {
                dt = results.ToList().ToDataTable<WHLeadMasterDto>();
        ...
        private void bindLineOfBusinessChart()
        {
            DataTable dt = new DataTable();
            WHLeadMasterData _whLeadMasterData = new WHLeadMasterData();
            IList<WHLeadMasterDto> results = _whLeadMasterData.getLiquidLineOfBusinessRecord();
            if (results != null)
            {
                dt = results.ToList().ToDataTable<WHLeadMasterDto>();
        ...
        private void getStatusStageAndBillingRecord()
        {
            DataTable dt = new DataTable();
            WHLeadMasterData _whLeadMasterData = new WHLeadMasterData();
            IList<WHLeadMasterDto> results = _whLeadMasterData.getLiquidStatusStageAndBillingRecord();
            if (results != null)
            {
                dt = results.ToList().ToDataTable<WHLeadMasterDto>();
