...
{
    public partial class FFDashboard : System.Web.UI.Page
    {
        string MyData;
        string RegionData;
        ...
        private void bindPipelineChart()
        {
            ...
            IList<WHLeadMasterDto> results = _whLeadMasterData.getFFPipelineSplitRecord();
            if (results != null)
            {
        ...
        private void bindGeographyChart()
        {
            DataTable dt = new DataTable();
            WHLeadMasterData _whLeadMasterData = new WHLeadMasterData();
            IList<WHLeadMasterDto> results = _whLeadMasterData.getFFRegionRecord();
            if (results != null)
            {
                dt = results.ToList().ToDataTable<WHLeadMasterDto>();
        ...
        private void bindLineOfBusinessChart()
        {
            DataTable dt = new DataTable();
            WHLeadMasterData _whLeadMasterData = new WHLeadMasterData();
            IList<WHLeadMasterDto> results = _whLeadMasterData.getFFLineOfBusinessRecord();
            if (results != null)
            {
                dt = results.ToList().ToDataTable<WHLeadMasterDto>();
        ...
        private void getStatusStageAndBillingRecord()
        {
            DataTable dt = new DataTable();
            WHLeadMasterData _whLeadMasterData = new WHLeadMasterData();
            IList<WHLeadMasterDto> results = _whLeadMasterData.getFFStatusStageAndBillingRecord();
            if (results != null)
            {
                dt = results.ToList().ToDataTable<WHLeadMasterDto>();
