...
{
    public partial class CFSInfraList : System.Web.UI.Page
    {
        int count;
        int count1 = 0;
        ...
        void bindGrid()
        {
            ...
            IList<WHLeadMasterDto> results = _whleadMasterData.GetByCustomerName(drpCustomerName.SelectedValue, CreateBy, string.Empty,
                ...
                LovelySession.Lovely.User.UserTypeId, "CFSinfra", LovelySession.Lovely.User.Id, string.Empty, txtCreateFromDate.Text, txtCreateToDate.Text,
        ...
        void StatusUpload()
        {
            ...
            if (fileUpload.HasFile)
            {
                try
                {
                    ...
                    request.UserTypeID = "20,21"; //LovelySession.Lovely.User.UserTypeId;
        ...
        protected void gvLeadList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                try
                {
                    ...
                    {
                        Response.Redirect("CFSInfra.aspx?lovelyindexing=119&requestId=" + requestId + "&726782dsjsbj=3877843hdws", false);
                    }
                    else
                    {
        ...
        protected void gvLeadList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label gvlblIsHold = (e.Row.FindControl("gvlblIsHold") as Label);
        ...
        {
            Response.Redirect("~/FrontEnd/Operations/CFSInfra.aspx");
        }
        ...
        protected void ExcelDownloadFile(object sender, EventArgs e)
        {
            ...
            DataSet result = _whLeadData.getForWhLeadMasterExelForCfsInfra(drpCustomerName.SelectedValue, drpNewEncirclement.SelectedValue,
