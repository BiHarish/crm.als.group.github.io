<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="GenerateInterest.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.SalesIncentives.GenerateInterest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>
            ...
            <asp:Label ID="lblSecHeading" runat="server" Text="Generate Interest"></asp:Label></h1>
    </section>
    <!-- Main content -->
                        ...
                        <div class="form-group">
                            ...
                            <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-info" data-loading-text="Loading...Please Wait"
                                Style="margin-top: 25px" OnClick="Q1_Click">
                                    <span class="glyphicon glyphicon-search"></span> Interest Q1
                            </asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" runat="server" class="btn btn-info" data-loading-text="Loading...Please Wait"
                                Style="margin-top: 25px" OnClick="Q2_Click">
                                    <span class="glyphicon glyphicon-search"></span> Interest Q2
                            </asp:LinkButton>
                            <asp:LinkButton ID="LinkButton3" runat="server" class="btn btn-info" data-loading-text="Loading...Please Wait"
                                Style="margin-top: 25px" OnClick="Q3_Click">
                                    <span class="glyphicon glyphicon-search"></span> Interest Q3
                            </asp:LinkButton>
                            <asp:LinkButton ID="LinkButton4" runat="server" class="btn btn-info" data-loading-text="Loading...Please Wait"
                                Style="margin-top: 25px" OnClick="Q4_Click">
                                    <span class="glyphicon glyphicon-search"></span> Interest Q4
                            </asp:LinkButton>
                        </div>
                    </div>
                </div>
