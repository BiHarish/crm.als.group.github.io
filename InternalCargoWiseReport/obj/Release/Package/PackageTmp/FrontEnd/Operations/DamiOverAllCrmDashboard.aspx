<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="DamiOverAllCrmDashboard.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.Operations.DamiOverAllCrmDashboard" %>
                ...
                "titles": [
                    {
                        "id": "Title-1",
                        "size": 15,
                        "text": "Pipeline by Product (in Crores)"
                    }
                ],
                "dataProvider": [
                <asp:Literal ID="ltrRvn" runat="server" ></asp:Literal>
              //  { "StatusStage": 'ALS-Singamas', "Value": 0},
               
                //{
                //    'category': 'StatusStage',
                //    'column-1': 1200
                //},
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content">
        ...
        <div class="row">
           ...
           <%-- <div class="col-md-6">
                <div class="form-group">
                    <label>Pipeline by Product</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>Pipeline by Product </label>
                    <div id="chartdiv12" style="width: 100%; height: 400px; background-color: lightgray;" ></div>
                </div>
