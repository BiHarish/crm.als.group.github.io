<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="CFSInfra.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.Operations.CFSInfra" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>
            <asp:Label ID="lblMainHeading" runat="server" Text="CFS"></asp:Label></h1>
    </section>
    <%--Main content--%>
        ...
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" ID="drpBusinessDriver" CssClass="form-control select2">
                                <asp:ListItem Value="">--Select--</asp:ListItem>
                                <asp:ListItem Value="ShippingLine">ShippingLine</asp:ListItem>
                                <asp:ListItem Value="CHA">CHA</asp:ListItem>
                                <asp:ListItem Value="MNC Forwarder">MNC Forwarder</asp:ListItem>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                             <label>Avg Realization Expected:<asp:Label ID="Label9" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label>
                                <asp:TextBox ID="txtRealizationExpected" runat="server" CssClass="form-control groupOfTexbox" >
                                </asp:TextBox>
                    ...
                    <div class="col-md-5">
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                                <label>Base Rate Exp.:<asp:Label ID="Label18" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label>
                                <asp:TextBox ID="txtBaseRateExpected" runat="server" CssClass="form-control groupOfTexbox" AutoPostBack="true" OnTextChanged="txtBaseRateExpected_TextChanged" >
                                </asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Expected Ground Rent:<asp:Label ID="Label8" runat="server" ForeColor="Red" Visible="false" Font-Bold="true" Text="*"></asp:Label></label>
                ...
                <%-- <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                            <label>Size Of Warehouse:<asp:Label ID="Label21" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label>
                            <asp:TextBox runat="server" ID="txtSizeOfWarehouse" CssClass="form-control" AutoComplete="off">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Enquiry Receive Date:<asp:Label ID="Label22" runat="server" ForeColor="Red" Font-Bold="true" Text="*" ></asp:Label></label>
                           
                            <asp:TextBox runat="server" ID="txtEnquiryReceiveDate" CssClass="form-control" AutoComplete="off"  onkeydown="return false">
                            </asp:TextBox>
                             
                             <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtEnquiryReceiveDate"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Target Submission Date:<asp:Label ID="Label23" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label>
                            <asp:TextBox runat="server" ID="txtTargetSubmissionDate" CssClass="form-control" AutoComplete="off" onkeydown="return false">
                            </asp:TextBox>
                              <ajaxToolkit:CalendarExtender ID="customCalendarExtender" runat="server" TargetControlID="txtTargetSubmissionDate"
                                CssClass="MyCalendar" Format="dd MMM yyyy" />
                        </div>
                    </div>
                     <div class="col-md-3">
                        <div class="form-group">
                            <label>Data Receive Date:<asp:Label ID="Label24" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label>
                            <asp:TextBox runat="server" ID="txtDataReceiveDate" CssClass="form-control" AutoComplete="off" onkeydown="return false">
                            </asp:TextBox>
                              <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtDataReceiveDate"
                                CssClass="MyCalendar" Format="dd MMM yyyy" />
                        </div>
                    </div>
                </div>
               <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Costing Readiness Date:<asp:Label ID="Label25" runat="server" ForeColor="Red" Font-Bold="true" Text="*" Visible="false"></asp:Label></label>
                            <asp:TextBox runat="server" ID="txtCostingReadinessDate" CssClass="form-control" AutoComplete="off" onkeydown="return false">
                            </asp:TextBox>
                              <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtCostingReadinessDate"
                                CssClass="MyCalendar" Format="dd MMM yyyy" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" ID="txtCostingReviewedDate" CssClass="form-control" AutoComplete="off" onkeydown="return false">
                              ...
                              <ajaxToolkit:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="txtCostingReviewedDate"
                                CssClass="MyCalendar" Format="dd MMM yyyy" />
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" ID="txtActualSubmissionDate" CssClass="form-control" AutoComplete="off" onkeydown="return false">
                              ...
                              <ajaxToolkit:CalendarExtender ID="CalendarExtender5" runat="server" TargetControlID="txtActualSubmissionDate"
                                CssClass="MyCalendar" Format="dd MMM yyyy" />
                        </div>
                    </div>
               </div>
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" ID="txtGoLiveDate" CssClass="form-control" AutoComplete="off" onkeydown="return false">
                              ...
                              <ajaxToolkit:CalendarExtender ID="CalendarExtender6" runat="server" TargetControlID="txtGoLiveDate"
                                CssClass="MyCalendar" Format="dd MMM yyyy" />
                        </div>
                    </div>
