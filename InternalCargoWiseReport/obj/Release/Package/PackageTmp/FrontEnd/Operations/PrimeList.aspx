<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="PrimeList.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.Operations.PrimeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>
            ...
            <asp:Label ID="lblSecHeading" runat="server" Text="Prime List"></asp:Label></h1>
    </section>
    <!-- Main content -->
