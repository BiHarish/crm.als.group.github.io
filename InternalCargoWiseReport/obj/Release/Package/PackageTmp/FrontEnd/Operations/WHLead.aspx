<%@ Page Title="ALS-CRM" Language="C#" MasterPageFile="~/FrontEnd/Slave.Master" AutoEventWireup="true" CodeBehind="WHLead.aspx.cs" Inherits="InternalCargoWiseReport.FrontEnd.Operations.WHLead" %>
        ...
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" ID="drpNewEncirclement" CssClass="form-control select2" AutoComplete="off">
                                ...
                                <asp:ListItem Value="Encirclement">Encirclement</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Project ETA:<asp:Label ID="lblProjectEtaStar" runat="server" Visible="false" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label>
                    ...
                    <div class="auto-style1">
                        <div class="form-group">
                            <label>Project ATA:<asp:Label ID="lblProjectATAStar" runat="server" ForeColor="Red" Visible="false" Font-Bold="true" Text="*"></asp:Label></label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Designated Solution:<asp:Label ID="lblDSStar" Visible="false" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="drpStage" runat="server" Style="width: 206px !important" AutoPostBack="true" OnSelectedIndexChanged="drpStage_SelectedIndexChanged1"  CssClass="form-Control select2">
                                <asp:ListItem Value="">--Select--</asp:ListItem>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <%--line of Business--%>
                            <label>
                                <asp:Label ID="lblLineOfBusiness" runat="server" Text="Line Of Business"></asp:Label><asp:Label ID="Label9" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label><br />
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>
                                Monthly Billing:<asp:Label ID="lblMonthlyStar" runat="server" ForeColor="Red" Font-Bold="true" Text="*" Visible="false">
                                </asp:Label></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>GP(%):<asp:Label ID="lblGpStar" runat="server" Visible="false" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Opportunity Brief:<asp:Label ID="Label11" runat="server" ForeColor="Red" Font-Bold="true" Text="*"></asp:Label></label>
                        ...
                        <div class="form-group">
                            <asp:GridView ID="gvContactPersonDetails" runat="server" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Name" HeaderStyle-Font-Bold="false" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox ID="gvtxtName" BorderWidth="1" runat="server" Text='<%#Eval("Name") %>' Width="100%"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Designation" HeaderStyle-Font-Bold="false" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox ID="gvtxtDesignation" BorderWidth="1" runat="server" Text='<%#Eval("Designation") %>' Width="100%"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="MailID" HeaderStyle-Font-Bold="false" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="PhoneNo" HeaderStyle-Font-Bold="false" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="GridHeader" ItemStyle-Wrap="false">
                                        <ItemTemplate>
                                            <asp:TextBox ID="gvtxtPhoneNo" BorderWidth="1" runat="server" Text='<%#Eval("PhoneNo") %>' Width="100%"
                                                AutoComplete="off" MaxLength="10" onpaste="return false;" oncut="return false;"
